    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(!options.pointIcon)
                this._options.pointIcon = L.icon({ iconUrl: 'assets/images/map-plot-waypoint.png', iconSize: [11, 11], iconAnchor: [6, 6] });
            if(!options.newPointIcon)
                this._options.newPointIcon = L.icon({ iconUrl: 'assets/images/map-plot-midpoint.png', iconSize: [11, 11], iconAnchor: [6, 6] });
        };
